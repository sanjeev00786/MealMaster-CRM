...
const PastDeliveries = () => {
    ...
    const getPastDeliveries = async (driver_id) => {
        setLoading(true);
        try {
            const responseData = await apiHelper.get(`${ENDPOINTS.GET_PAST_DELIVRIES}driver_id=a539a554-15d8-4eda-9c0e-2d519bcbfd24`);
            if (responseData.success === true) {
                ...
                setpastDeliveriesData(prevCustomerData => [...prevCustomerData, ...customers]);
