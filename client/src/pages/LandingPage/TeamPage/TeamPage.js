...
const profiles = [
  {
    ...
    description:
      "Passionate software developer with a proven track record in iOS development, now expanding expertise in web and mobile design & development at Langara College. Skilled in app optimization and committed to driving innovation and success in every project undertaken.",
  ...
  },
  {
    ...
    description:
      "Passionate full-stack developer adept in React, JavaScript, Express, and Tailwind CSS, with proficiency in Java and various frameworks. Dedicated to crafting robust and scalable solutions that push the boundaries of innovation.",
  ...
  },
  {
    ...
    designation: "Full Stack Developer",
    description:
      "Gurmeet Is an enthusiastic Full Stack Developer with a keen interest in both front-end and back-end development. With a passion for design and a drive to master the full stack, He brings a versatile skill set to our team, poised to make valuable contributions across all aspects of development.",
  ...
  },
  {
    ...
    designation: "Full Stack Developer",
    description:
      "Currently pursuing a career in Full Stack Web Development. I strive`s to make impactful contributions to the ever-evolving landscape of web app development.",
  ...
  },
  {
    ...
    designation: "Full Stack Developer",
    description:
      "Just a regular dude who likes programming and building cool stuff with fancy tech.",
    linkedin: "https://www.linkedin.com/in/nandan-nishad-179102166/",
    image: Nandan,
  ...
  },
  {
    ...
    designation: "UI/UX Designer",
    description:
      "A passionate UI/UX designer, excel in crafting immersive digital experiences. He loves the world of digital art and spend time creating photo manipulation, that bring a unique and creative touch to his work.",
  ...
  },
  {
    ...
    designation: "UI/UX Designer",
    description:
      "Currently advancing his expertise in Web and Mobile App Design with a Post-Degree Diploma from Langara College, Vancouver. He is passionate about blending creative design with user-centric technology to innovate digital experiences.",
